...
int main() {
	...
	*/
	...
	/*
	 we declared single-argument constructor(int) explicit to prohibit 
	 the compiler from using it	for any implicit conversion, :
	 With such a declaration, the invocation in the example 
	 below (nancy = 466) would generate a compiler error.
	*/
    
	//nancy = 466; // compiler error due to explicit keyword in constrcut decleration.
	/*nancy.display();
	cout << endl;*/

	//Student josee = 466; // compiler error due to explicit keyword in constrcut decleration.
